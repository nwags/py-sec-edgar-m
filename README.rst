...
A Python application for structured ingestion, normalization, and extraction of SEC EDGAR filings,
supporting downstream analytics and event-driven workflows.

========================
py-sec-edgar (extended)
========================

This repository is a significantly extended and refactored version of the original
`py-sec-edgar` project by Ryan S. McCoy.

The original project provided a lightweight system for downloading and parsing SEC EDGAR filings.
This version expands that foundation into a structured data ingestion and extraction pipeline.
...
This repository includes substantial modifications and extensions, including:

- Refdata normalization layer (entities, issuers, aliases)
- EDGAR index ingestion and parquet materialization
- Backfill pipeline architecture
- Filing-party extraction system
- CLI interface redesign (Click-based)
- Runtime hardening and modern dependency compatibility
- Structured storage for downstream analytics

The original license and copyright are preserved.
