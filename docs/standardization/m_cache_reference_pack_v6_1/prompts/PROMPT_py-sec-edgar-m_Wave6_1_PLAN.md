...
- Converge from the current repo-specific external-root/env handling to the canonical Wave 6.1 external identity and shim contract.
- Preserve `py_sec_edgar.wave4_shared._shared_backend` as the first-hop facade during convergence.
