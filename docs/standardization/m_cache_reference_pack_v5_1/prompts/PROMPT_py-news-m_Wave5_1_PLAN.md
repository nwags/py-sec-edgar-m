...
- Identify exact compatibility re-export/shim needs during that migration.
- Keep article parsing, text selection, storage placement, idempotency logic, and live write-path persistence local.
